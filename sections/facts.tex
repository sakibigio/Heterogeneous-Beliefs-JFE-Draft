...
\input{tables/tab_nx_regression}

Belief heterogeneity is also reflected in trading behavior. \citet{greenwood_expectations_2014} shows that subjective expectations correlate with mutual fund flows, and \citet{GMSU_AER} documents a relationship between beliefs and portfolio choices. In Section~\ref{sec:belief_taxonomy.sec}, we construct an analyst-disagreement measure and show that it correlates with stock-market turnover, especially during recessions.

\paragraph{Fact 3. Expectations correlate with hiring decisions.}

\input{tables/tab_payroll}
...
% }
Motivated by the three facts, we proceed to the model.