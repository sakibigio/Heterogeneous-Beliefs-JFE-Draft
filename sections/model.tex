...
\begin{equation}\label{eq: flow_bc}
    C_{i,t} + Q_t S_{i,t} + B_{i,t} = R_{r,t} Q_{t-1} S_{i,t-1} + R_{f,t} B_{i,t-1} + W_t h_{i,t}.
\end{equation}
