...
\begin{enumerate}[start=3]
    \item The data in table 3 is taken from three diﬀerent papers – with in some cases
...
\begin{enumerate}[start=5]
    ...
    does not change. That's a shock --- the realization of TFP growth diﬀers from its
    conditional expectation --- but it does not aﬀect beliefs. For this reason, I am not
...
\begin{enumerate}[start=10]
    ...
    the eﬀects of the subsequent decline in TFP growth
\end{enumerate}
}
